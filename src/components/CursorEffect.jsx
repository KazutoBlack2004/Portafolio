...
export default function CursorEffect() {
  ...
  const fragmentShaderSource = `
    ...
    void main() {
        ...
        // Premium dark-mode aesthetic (purple/indigo)
        color = vec3(0.5, 0.1, 0.9); 
        color += vec3(0.2, 0.0, 0.5) * sin(3.0 * u_scroll_progress + 1.5); 
        color = color * noise;
  ...
  useEffect(() => {
    ...
    const handleTouchMove = (e) => updateMousePosition(e.touches[0].clientX, e.touches[0].clientY);
